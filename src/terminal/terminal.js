...
import { addLine, blank, createBlock, printBlock } from "../tools/utilities.js";
import { pageMap } from "./autocomplete.js";
import { lastHist, nextHist, pushHist } from "./histstate.js";
...
function boot() {
	...
	addLine(block, "chroot v0.3.0 - speciality coffee", "info");
	addLine(block, "Type 'help' for available commands", "info");
	blank(block);
	printBlock(block);
}
