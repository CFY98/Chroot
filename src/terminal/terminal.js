            ...
            switch (verb) {
                ...
                case "cd": {
                    ...
                    if (!target) {
                        ...
                        addLine(
                            block,
                            `bash: ${verb}: ${arg}: No such page`,
                            "error",
                        );
                        addLine(
                            block,
                            `hint: type 'ls' to see available pages`,
                            "warn",
                        );
                    } else {
                        addLine(block, `site@chroot ~/${command} $`, "success");
                ...
                case "about":
                    ...
                    addLine(
                        block,
                        "  Change the root of your trajectory",
                        "info",
                    );
                    ...
                    addLine(
                        block,
                        "  Chroot is a specialty coffee roastery",
                        "info",
                    );
                    addLine(
                        block,
                        "  inspired by the Unix command line",
                        "info",
                    );
                    addLine(
                        block,
                        "  where you commit to every cup of",
                        "info",
                    );
